...
## Using this Document
This document contains a series of several sections, each of which explains a particular aspect of Docker. In each section, you will be typing commands (or writing code). All the code used in the tutorial is available in the [Github repo](https://github.com/merapar/docker-tutorial).
...
> Note: This tutorial uses version **1.10.1** of Docker. If you find any part of the tutorial incompatible with a future version, please raise an [issue](https://github.com/merapar/docker-tutorial/issues). Thanks!
...
drwxr-xr-x    1 root     root          4096 Nov  7 07:09 etc
drwxr-xr-x    2 root     root          4096 Oct 25 22:05 home
drwxr-xr-x    5 root     root          4096 Oct 25 22:05 lib
...
$ docker ps -a
CONTAINER ID        IMAGE                                 COMMAND                  CREATED              STATUS                          PORTS               NAMES
e31379b50e42        alpine                                "/bin/sh"                18 seconds ago       Exited (127) 9 seconds ago                          fervent_bardeen
6a159363e10d        alpine                                "/bin/sh"                About a minute ago   Exited (0) About a minute ago                       heuristic_chandrasekhar
5ceb46dcb0a7        alpine                                "uptime"                 About a minute ago   Exited (0) About a minute ago                       wonderful_tesla
06a5ee5c8a96        alpine                                "echo 'hello from al…"   About a minute ago   Exited (0) About a minute ago                       dreamy_engelbart
0b9d31e2a7a5        alpine                                "ls -l"                  About a minute ago   Exited (0) About a minute ago                       fervent_morse
30012cf8c52f        hello-world                           "/hello"                 3 minutes ago        Exited (0) 3 minutes ago                            hardcore_goodall
```
...
$ docker ps
CONTAINER ID        IMAGE                  COMMAND                  CREATED             STATUS              PORTS               NAMES
16379f272bdf        seqvence/static-site   "/bin/sh -c 'cd /usr…"   About a minute ago  Up About a minute   80/tcp, 443/tcp     epic_payne
```
...
```
$ docker stop 16379f272bdf
$ docker rm   16379f272bdf
```
...
f1c2cdb1c04cef489021bd2113de2e8be6f5fad3ebd2f65b1b6a552736af5cbf
```
...
You can now open [http://localhost:32769](http://localhost:32769) (replace 32769 with your port for 80/tcp) to see your site live!
...
```
<img src="https://raw.githubusercontent.com/merapar/docker-tutorial/master/tutorial-images/static.png" title="static">
...
Clone the voting-app repository already available at [Github Repo](https://github.com/merapar/docker-tutorial.git).

```
git clone https://github.com/merapar/docker-tutorial.git
```
...
<a id="wrap-up"></a>
## 4.0 You made it!
Well done! You are now ready to take the container world by storm! If you followed along till the very end then you should definitely be proud of yourself. You learned how to install docker, run your own containers, use Docker Compose to create a multi-container application.

Now that you have finished the tutorial!
...
- [Merapar's Blog](https://blog.merapar.com/)
